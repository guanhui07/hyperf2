...
class WebSocketController extends AbstractController implements OnMessageInterface, OnOpenInterface, OnCloseInterface
{
    ...
    public function onMessage(WebSocketServer $server, Frame $frame) : void
    {
        /**
         * [
         *    'cmd'=>'group.send', //控制器.path
         *    'data'=>[
         *               'from_user_id'=>102,
         *               'to_id'=>412,
         *               'message_id'=>'dsfdfdff', //12位由前端生成
         *               'content'=>'test', //内容
         *              ],
         *      'ext'=>[], //扩展字段
         *   ]
    ...
    public function onOpen(WebSocketServer $server, Request $request) : void
    {
         ...
         */
        $user        = WsContext::get('user'); //这里 有用到 个 中间件Auth  ，这里是websocket上下文
        ...
        $atomic = AtomicManager::get(Atomic::NAME); //计数器
        $atomic->add(1);
